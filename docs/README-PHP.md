...
Shared setup topics such as layouts, languages, footer syntax, CSS and editor/media access are in [`README-INTRO.md`](./README-INTRO.md). Full details for public helper functions such as `zlink()` and `zhref()` are in [`README-INTERFACES.md`](./README-INTERFACES.md).
...
- [`README-INTERFACES.md`](./README-INTERFACES.md) for public PHP function parameters and customisation interfaces
