...
In Rich mode `/admin/_e.php` loads the Rich editor. The editor uses local Squire files from:
...
Then add it to the navigation through `/admin/_n.php`, or manually in `/pages/__navi.data.php`:
...
For Markdown sites see [`README-MD.md`](./README-MD.md). For PHP page fragments and full PHP mode see [`README-PHP.md`](./README-PHP.md).
...
- [`README-MD.md`](./README-MD.md) for Markdown-based sites
